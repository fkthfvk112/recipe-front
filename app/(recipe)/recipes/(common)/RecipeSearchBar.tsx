...
export default function RecipeSearchBar() {
  ...
  return (
    ...
    {/* 2. horizontal Badge filter list */}
      <div className={`w-full max-w-[800px] px-5 pb-3.5 flex items-center gap-2 relative overflow-x-auto no-scrollbar scroll-smooth ${activePopover ? "sm:overflow-visible" : ""}`}>
