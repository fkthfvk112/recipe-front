...
export default function Button({
  ...
  const variants = {
    ...
    secondary: "bg-mugin-secondary text-white border-transparent hover:bg-[#487373]",
    ...
    "outline-secondary": "bg-white text-mugin-secondary border-mugin-secondary hover:bg-teal-50",
