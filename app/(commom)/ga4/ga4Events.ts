...
export const authEvents = {
  ...
  // 로그인 시도
  submitSignIn: (method: 'normal' | 'naver' | 'kakao' | 'google' = 'normal') => {
  ...
  // 로그인 성공
  signInSuccess: (method: 'normal' | 'naver' | 'kakao' | 'google' = 'normal') => {
  ...
  // 로그인 실패
  signInFailure: (reason: string, method: 'normal' | 'naver' | 'kakao' | 'google' = 'normal') => {
  ...
  // 회원가입 완료
  signUpSuccess: (method: 'normal' | 'naver' | 'kakao' | 'google' = 'normal') => {
